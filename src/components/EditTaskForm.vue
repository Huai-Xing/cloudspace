  ...
  <Modal v-show="isModalVisible" @close="closeModal">
    ...
    <template v-slot:body>
      <form id="edit-task-form">
        ...
        <input v-model="updatedtask.title" type="text" id="title" v-bind:placeholder="currentTask.title" />
        <br />
        <label for="edit-task-category">Category</label>
        <select v-model="updatedtask.category" :disabled="disabledselect" id="edit-task-category">
          <option disabled value="">Please select a new catergory for your task</option>
        ...
        <br />
        Duration
        <vue-timepicker manual-input close-on-complete v-model="updatedtask.duration.hh" format="HH"></vue-timepicker>
        hr
        <vue-timepicker manual-input close-on-complete v-model="updatedtask.duration.mm" format="mm"></vue-timepicker>
        min
      </form>
    </template>
