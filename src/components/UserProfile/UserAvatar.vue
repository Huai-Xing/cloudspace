...
<div class="content">
  <div id="avatar">
    ...
    <img id="avatarIMG" src="../../assets/avatar/Avatar_1.png" v-if="user.imageIdx == 0" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_2.png" v-else-if="user.imageIdx == 1" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_3.png" v-else-if="user.imageIdx == 2" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_4.png" v-else-if="user.imageIdx == 3" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_5.png" v-else-if="user.imageIdx == 4" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_6.png" v-else-if="user.imageIdx == 5" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_7.png" v-else-if="user.imageIdx == 6" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_8.png" v-else-if="user.imageIdx == 7" />
    <img id="avatarIMG" src="../../assets/avatar/Avatar_9.png" v-else-if="user.imageIdx == 8" />
